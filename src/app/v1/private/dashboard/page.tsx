...
export default function DashboardPage() {
  return (
    <PageTransition className="flex-1 w-full flex flex-col items-center justify-start p-6 md:p-12 relative overflow-x-hidden min-h-screen">
      ...
      <div className="absolute top-[30%] left-[40%] w-[20%] h-[20%] bg-accent-gold/5 blur-[100px] rounded-full pointer-events-none" />
